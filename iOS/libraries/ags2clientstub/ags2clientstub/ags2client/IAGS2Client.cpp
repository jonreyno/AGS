...
std::unordered_map<std::string, void*> IAGS2Client_Statics::FUNCTIONS;
...
{
    std::unordered_map<std::string, void*> &functions = IAGS2Client_Statics::FUNCTIONS; // RegisterScriptFunction does not copy the buffer, we must persist it ourselves
