...
#include "../iOS/libraries/ags2clientstub/ags2clientstub/ags2client/main.h"
...
bool pl_use_builtin_plugin(EnginePlugin* apl)
{
    ...
    else if (stricmp(apl->filename, "agsteam") == 0)
    {
        apl->engineStartup = AGS2Client::AGS_EngineStartup;
        apl->engineShutdown = AGS2Client::AGS_EngineShutdown;
        apl->onEvent = AGS2Client::AGS_EngineOnEvent;
        apl->debugHook = AGS2Client::AGS_EngineDebugHook;
        apl->initGfxHook = AGS2Client::AGS_EngineInitGfx;
        apl->available = true;
        apl->builtin = true;
        return true;
    }
